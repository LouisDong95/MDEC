...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='mnist', choices=['mnist', 'mnist_test', 'usps', 'reuters10k', 'fashion_mnist'])
    ...
    if args.dataset == 'mnist':  # recommends: n_clusters=10, update_interval=140
        ...
        x, _, y = load_fashion_mnist()
        optimizer = 'adam'
    elif args.dataset == 'usps':  # recommends: n_clusters=10, update_interval=30
        x, _, y = load_usps()
    elif args.dataset == 'reuters10k':  # recommends: n_clusters=4, update_interval=3
        x, y = load_reuters()
    ...
    # plot_model(idec.model, to_file=args.save_dir + 'idec_model.png', show_shapes=True)
    idec.model.summary()
